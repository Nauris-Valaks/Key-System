...
namespace projectDesign {
    ...
    public partial class LoginsDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AccountsRow AddAccountsRow(string Forename, string Surname, string Username, string Password) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public string Forename {
                get {
                    try {
                        return ((string)(this[this.tableAccounts.ForenameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Forename\' in table \'Accounts\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableAccounts.ForenameColumn] = value;
                }
            }
            ...
            public bool IsForenameNull() {
                return this.IsNull(this.tableAccounts.ForenameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetForenameNull() {
                this[this.tableAccounts.ForenameColumn] = global::System.Convert.DBNull;
            }
...
namespace projectDesign.LoginsDataSetTableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Accounts` WHERE ((`ID` = ?) AND ((? = 1 AND `Forename` IS NULL) OR (`Forename` = ?)) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Accounts` (`Forename`, `Surname`, `Username`, `Password`) VALUES (?," +
                " ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Accounts` SET `Forename` = ?, `Surname` = ?, `Username` = ?, `Password` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Forename` IS NULL) OR (`Forename` = ?)) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::projectDesign.Properties.Settings.Default.LoginsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Forename, Surname, Username, [Password] FROM Accounts";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Username Password FROM Accounts\r\nWHERE Username = ANY(SELECT username AND " +
                "password)\r\n\r\n";
        ...
        public virtual int Fill(LoginsDataSet.AccountsDataTable dataTable) {
        ...
        public virtual LoginsDataSet.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginsDataSet.AccountsDataTable dataTable = new LoginsDataSet.AccountsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginsDataSet.AccountsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Forename, string Original_Surname, string Original_Username, string Original_Password) {
        ...
        public virtual int Insert(string Forename, string Surname, string Username, string Password) {
            if ((Forename == null)) {
        ...
        public virtual int Update(string Forename, string Surname, string Username, string Password, int Original_ID, string Original_Forename, string Original_Surname, string Original_Username, string Original_Password) {
            if ((Forename == null)) {
